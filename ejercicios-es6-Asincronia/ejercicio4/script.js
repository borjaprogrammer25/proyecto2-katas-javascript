...
const ages18up = ages.filter((age) => age > 18);
...
const streamersLeagueLegend = streamers.filter((streamer) => streamer.gameMorePlayed === "League of Legends");
console.log(streamersLeagueLegend);
...
const streamer35Legend = streamers.filter((streamer) => 
{
